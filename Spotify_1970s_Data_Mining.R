...
## the popularity score of a song, and what variables are at play the most in
...
specific.alumnus <- spotify_1970s1[sample(nrow(spotify_1970s1),1),]
plot( predict_parts(explainer = shop_explainer, new_observation = specific.alumnus, type = "break_down") )
spotify_1970s[891,]

specific.alumnus1 <- spotify_1970s1[sample(nrow(spotify_1970s1),1),]
