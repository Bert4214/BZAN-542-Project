...
# RMSE = 11.8918636, R2 = 0.2042275, cp = 0.1, not overfit
...
specific.alumnus <- spotify_1980s1[sample(nrow(spotify_1980s1),1),]
plot( predict_parts(explainer = shop_explainer, new_observation = specific.alumnus, type = "break_down") )
spotify_1980s[891,]

specific.alumnus1 <- spotify_1980s1[sample(nrow(spotify_1980s1),1),]
