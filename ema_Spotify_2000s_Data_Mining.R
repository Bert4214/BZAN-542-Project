...
spotify_2000s = read.csv("spotify_2000s.csv")

# Data Prep for Modeling
spotify_2000s1 = spotify_2000s[,-c(1:4,8:10,24:25)]
spotify1 = spotify_2000s1
...
specific.alumnus <- spotify_2000s1[sample(nrow(spotify_2000s1),1),]
plot( predict_parts(explainer = shop_explainer, new_observation = specific.alumnus, type = "break_down") )
spotify_2000s[891,]

specific.alumnus1 <- spotify_2000s1[sample(nrow(spotify_2000s1),1),]
