...
# 1990s---RMSE = 12.04457, R2 = 0.2154806, cp = 0.2130941,MAE=9.544729 
...
specific.alumnus <- spotify_1990s1[sample(nrow(spotify_1990s1),1),]
plot( predict_parts(explainer = shop_explainer, new_observation = specific.alumnus, type = "break_down") )
spotify_1990s[891,]

specific.alumnus1 <- spotify_1990s1[sample(nrow(spotify_1990s1),1),]
